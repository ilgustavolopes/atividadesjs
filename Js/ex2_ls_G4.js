...
function obterListaTentativas(){
    localStorage.getItem('tentativas') || [];
}
function salvarListaTentativas(lista){
    localStorage.setItem('tentativas', lista);
}

let listTent  = obterListaTentativas();
console.log(listTent);
...
function submit(){
    ...
    listTent.push(inNumberPlayer);
    console.log(listTent);
    salvarListaTentativas(listTent);
